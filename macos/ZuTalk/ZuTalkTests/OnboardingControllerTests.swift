...
final class OnboardingControllerTests: XCTestCase {
    ...
    override func setUp() async throws {
        ...
        originalOnboardingCompleted = UserDefaults.standard.object(
            forKey: "zutalk.onboarding.completed"
        )
        UserDefaults.standard.removeObject(forKey: "zutalk.onboarding.completed")
    }
    ...
    func testCompletedOnboardingDoesNotReappearWhenPermissionNeedsRenewal() {
        UserDefaults.standard.set(true, forKey: "zutalk.onboarding.completed")
    ...
    func testFinishDoesNotCollectOrPersistProviderCredentials() {
        ...
        XCTAssertTrue(UserDefaults.standard.bool(forKey: "zutalk.onboarding.completed"))
    }
