 ...
 * ZuTalk 核心入口
 */
public protocol ZuTalkCoreProtocol: AnyObject, Sendable {
 ...
 * ZuTalk 核心入口
 */
open class ZuTalkCore: ZuTalkCoreProtocol, @unchecked Sendable {
    ...
    public func uniffiCloneHandle() -> UInt64 {
        return try! rustCall { uniffi_vt_ffi_fn_clone_zutalkcore(self.handle, $0) }
    }
    ...
    deinit {
        ...
        try! rustCall { uniffi_vt_ffi_fn_free_zutalkcore(handle, $0) }
    }
     ...
     */
public static func newDeferred(dataDir: String)throws  -> ZuTalkCore  {
    return try  FfiConverterTypeZuTalkCore_lift(try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_constructor_zutalkcore_new_deferred(
...
open func apiVersion() -> String  {
    ...
    uniffi_vt_ffi_fn_method_zutalkcore_api_version(
...
open func availableLocales() -> [String]  {
    ...
    uniffi_vt_ffi_fn_method_zutalkcore_available_locales(
            self.uniffiCloneHandle(),$0
    )
})
}
...
open func clearApiKey(scope: String)throws   {try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_clear_api_key(
...
open func completeProviderCredentialBootstrap()  {try! rustCall() {
    uniffi_vt_ffi_fn_method_zutalkcore_complete_provider_credential_bootstrap(
            self.uniffiCloneHandle(),$0
    )
}
}
...
open func currentLocale() -> String  {
    return try!  FfiConverterString.lift(try! rustCall() {
    uniffi_vt_ffi_fn_method_zutalkcore_current_locale(
            self.uniffiCloneHandle(),$0
    )
})
}
...
open func destroySessionAudioAndKey(sessionId: String)throws   {try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_destroy_session_audio_and_key(
            self.uniffiCloneHandle(),
...
open func getPrivacyDefault() -> String  {
    return try!  FfiConverterString.lift(try! rustCall() {
    uniffi_vt_ffi_fn_method_zutalkcore_get_privacy_default(
            self.uniffiCloneHandle(),$0
    )
})
}
...
open func getSession(id: String)throws  -> SessionInfo  {
    ...
    uniffi_vt_ffi_fn_method_zutalkcore_get_session(
            self.uniffiCloneHandle(),
...
open func hasApiKey(scope: String) -> Bool  {
    ...
    uniffi_vt_ffi_fn_method_zutalkcore_has_api_key(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(scope),$0
    )
})
...
open func listTrashedSessions()throws  -> [SessionInfo]  {
    ...
    uniffi_vt_ffi_fn_method_zutalkcore_list_trashed_sessions(
            self.uniffiCloneHandle(),$0
    )
})
}
...
open func purgeSession(sessionId: String)throws   {try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_purge_session(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(sessionId),$0
    )
}
...
open func querySessions(sessionType: String?, status: String?, searchText: String?, limit: UInt32?, offset: UInt32?)throws  -> SessionQueryResultInfo  {
    ...
    uniffi_vt_ffi_fn_method_zutalkcore_query_sessions(
            self.uniffiCloneHandle(),
...
open func restoreSession(sessionId: String)throws   {try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_restore_session(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(sessionId),$0
    )
}
...
open func searchSessions(query: String, limit: UInt32)throws  -> [SearchResultInfo]  {
    ...
    uniffi_vt_ffi_fn_method_zutalkcore_search_sessions(
            self.uniffiCloneHandle(),
...
open func setApiKey(scope: String, value: String)throws   {try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_set_api_key(
            self.uniffiCloneHandle(),
...
open func setLocale(tag: String)  {try! rustCall() {
    uniffi_vt_ffi_fn_method_zutalkcore_set_locale(
            self.uniffiCloneHandle(),
...
open func setPrivacyDefault(level: String)throws   {try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_set_privacy_default(
            self.uniffiCloneHandle(),
...
open func shutdown()throws   {try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_shutdown(
            self.uniffiCloneHandle(),$0
    )
}
}
...
open func softDeleteSession(sessionId: String)throws   {try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_soft_delete_session(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(sessionId),$0
    )
}
...
open func softDeleteSessions(sessionIds: [String])throws   {try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_soft_delete_sessions(
            self.uniffiCloneHandle(),
...
open func verifyApiKey(scope: String, candidate: String?)async throws  -> FfiProviderConnectionCheck  {
    return
        try  await uniffiRustCallAsync(
            rustFutureFunc: {
                uniffi_vt_ffi_fn_method_zutalkcore_verify_api_key(
                    self.uniffiCloneHandle(),
...
open func blockDocumentClose(docId: String)throws   {try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_block_document_close(
            self.uniffiCloneHandle(),
...
open func blockDocumentOpen(docId: String, kind: FfiDocumentKind)throws   {try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_block_document_open(
            self.uniffiCloneHandle(),
...
open func noteApplyOutline(docId: String, rows: [FfiOutlineRow])throws   {try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_note_apply_outline(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(docId),
...
open func noteBlockDocumentOpen(notebookId: String, tabId: String)throws  -> String  {
    ...
    uniffi_vt_ffi_fn_method_zutalkcore_note_block_document_open(
            self.uniffiCloneHandle(),
...
open func noteOutlineRows(docId: String)throws  -> [FfiOutlineRow]  {
    ...
    uniffi_vt_ffi_fn_method_zutalkcore_note_outline_rows(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(docId),$0
    )
})
...
open func noteRedo(docId: String)throws  -> FfiNoteUndoState  {
    ...
    uniffi_vt_ffi_fn_method_zutalkcore_note_redo(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(docId),$0
    )
})
...
open func noteUndo(docId: String)throws  -> FfiNoteUndoState  {
    return try  FfiConverterTypeFfiNoteUndoState_lift(try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_note_undo(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(docId),$0
    )
})
...
open func noteUndoState(docId: String)throws  -> FfiNoteUndoState  {
    return try  FfiConverterTypeFfiNoteUndoState_lift(try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_note_undo_state(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(docId),$0
    )
})
...
open func transcriptBlocks(docId: String)throws  -> [FfiUtteranceBlock]  {
    ...
    uniffi_vt_ffi_fn_method_zutalkcore_transcript_blocks(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(docId),$0
    )
})
...
open func transcriptInsertAnnotation(docId: String, index: UInt32, annotationId: String, text: String)throws   {try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_transcript_insert_annotation(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(docId),
...
open func transcriptMachineUpsert(docId: String, write: FfiMachineBlockWrite, frozenLanes: [String])throws   {try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_transcript_machine_upsert(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(docId),
...
open func transcriptUserReplaceLane(docId: String, blockId: String, lane: String, text: String)throws   {try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_transcript_user_replace_lane(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(docId),
...
open func transcriptUserReplaceText(docId: String, blockId: String, text: String)throws   {try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_transcript_user_replace_text(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(docId),
        FfiConverterString.lower(blockId),
        FfiConverterString.lower(text),$0
...
open func applyEdit(notebookId: String, tabId: String, op: FfiEditOp)throws   {try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_apply_edit(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(notebookId),
...
open func closeEditor(notebookId: String, tabId: String)throws   {try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_close_editor(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(notebookId),
        FfiConverterString.lower(tabId),$0
    )
...
open func flushAllEditorsSync()throws   {try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_flush_all_editors_sync(
            self.uniffiCloneHandle(),$0
    )
}
}
...
open func getEditorContent(notebookId: String, tabId: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_get_editor_content(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(notebookId),
        FfiConverterString.lower(tabId),$0
    )
...
open func getEditorDelta(notebookId: String, tabId: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_get_editor_delta(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(notebookId),
        FfiConverterString.lower(tabId),$0
    )
...
open func isEditorWritable(notebookId: String, tabId: String)throws  -> Bool  {
    ...
    uniffi_vt_ffi_fn_method_zutalkcore_is_editor_writable(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(notebookId),
        FfiConverterString.lower(tabId),$0
    )
...
open func openEditor(notebookId: String, tabId: String)throws   {try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_open_editor(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(notebookId),
        FfiConverterString.lower(tabId),$0
    )
...
open func registerEditorCallback(notebookId: String, tabId: String, callback: FfiEditorCallback)throws   {try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_register_editor_callback(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(notebookId),
        FfiConverterString.lower(tabId),
...
open func unregisterEditorCallback(notebookId: String, tabId: String)throws   {try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_unregister_editor_callback(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(notebookId),
        FfiConverterString.lower(tabId),$0
    )
...
open func importAudioIntoNotebook(path: String, notebookId: String)throws  -> ImportResultInfo  {
    ...
    uniffi_vt_ffi_fn_method_zutalkcore_import_audio_into_notebook(
            self.uniffiCloneHandle(),
...
open func listNotebookSessionProjections(tabId: String)throws  -> [FfiNotebookSessionProjection]  {
    ...
    uniffi_vt_ffi_fn_method_zutalkcore_list_notebook_session_projections(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(tabId),$0
    )
})
...
open func listNotebookSessions(notebookId: String)throws  -> [FfiNotebookSessionLink]  {
    ...
    uniffi_vt_ffi_fn_method_zutalkcore_list_notebook_sessions(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(notebookId),$0
    )
})
...
open func listNotebookTabs(notebookId: String)throws  -> [FfiNotebookTab]  {
    ...
    uniffi_vt_ffi_fn_method_zutalkcore_list_notebook_tabs(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(notebookId),$0
    )
})
...
open func listNotebooks()throws  -> [FfiNotebook]  {
    ...
    uniffi_vt_ffi_fn_method_zutalkcore_list_notebooks(
            self.uniffiCloneHandle(),$0
    )
})
}
...
open func moveSessionToNotebook(sessionId: String, targetNotebookId: String)throws   {try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_move_session_to_notebook(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(sessionId),
...
open func renameNotebookManualNote(notebookId: String, sessionId: String, title: String?)throws  -> FfiNotebookSessionProjection  {
    ...
    uniffi_vt_ffi_fn_method_zutalkcore_rename_notebook_manual_note(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(notebookId),
        FfiConverterString.lower(sessionId),
        FfiConverterOptionString.lower(title),$0
...
open func copyNotebookPrivateContextToLibrary(notebookId: String, title: String)throws  -> FfiContextPackInfo  {
    ...
    uniffi_vt_ffi_fn_method_zutalkcore_copy_notebook_private_context_to_library(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(notebookId),
...
open func createLibraryContextPack(title: String)throws  -> FfiContextPackInfo  {
    return try  FfiConverterTypeFfiContextPackInfo_lift(try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_create_library_context_pack(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(title),$0
    )
})
...
open func deleteContextPackSource(notebookId: String, sourceId: String)throws  -> Bool  {
    return try  FfiConverterBool.lift(try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_delete_context_pack_source(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(notebookId),
...
open func deleteLibraryContextPack(packId: String, expectedRevision: UInt64)throws  -> Bool  {
    return try  FfiConverterBool.lift(try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_delete_library_context_pack(
            self.uniffiCloneHandle(),
...
open func exportContextPack(notebookId: String, packId: String, destinationPath: String)throws  -> UInt32  {
    ...
    uniffi_vt_ffi_fn_method_zutalkcore_export_context_pack(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(notebookId),
        FfiConverterString.lower(packId),
...
open func failLaneCredential(requestId: String, message: String, terminal: Bool)  {try! rustCall() {
    uniffi_vt_ffi_fn_method_zutalkcore_fail_lane_credential(
            self.uniffiCloneHandle(),
...
open func fulfillLaneCredential(requestId: String, apiKey: String)  {try! rustCall() {
    uniffi_vt_ffi_fn_method_zutalkcore_fulfill_lane_credential(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(requestId),
...
open func getNotebookCaptureEngineDescriptor() -> FfiNotebookCaptureEngineDescriptor  {
    ...
    uniffi_vt_ffi_fn_method_zutalkcore_get_notebook_capture_engine_descriptor(
            self.uniffiCloneHandle(),$0
    )
})
}
...
open func getNotebookCaptureProfile(notebookId: String)throws  -> FfiNotebookCaptureProfile  {
    ...
    uniffi_vt_ffi_fn_method_zutalkcore_get_notebook_capture_profile(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(notebookId),$0
    )
})
...
open func getNotebookCaptureSessionEvent(sessionId: String)throws  -> FfiNotebookCaptureEvent  {
    ...
    uniffi_vt_ffi_fn_method_zutalkcore_get_notebook_capture_session_event(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(sessionId),$0
    )
})
...
open func importContextPack(sourcePath: String, titleOverride: String?)throws  -> FfiContextPackInfo  {
    return try  FfiConverterTypeFfiContextPackInfo_lift(try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_import_context_pack(
            self.uniffiCloneHandle(),
...
open func importContextPackText(notebookId: String, packId: String, title: String, text: String, contentKind: String)throws  -> FfiContextPackSourceInfo  {
    ...
    uniffi_vt_ffi_fn_method_zutalkcore_import_context_pack_text(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(notebookId),
        FfiConverterString.lower(packId),
...
open func interruptNotebookCaptureSession(sessionId: String, reason: FfiNotebookCaptureInterruptReason)throws  -> FfiNotebookCaptureEvent  {
    return try  FfiConverterTypeFfiNotebookCaptureEvent_lift(try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_interrupt_notebook_capture_session(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(sessionId),
...
open func listContextPackSources(notebookId: String, packId: String)throws  -> [FfiContextPackSourceInfo]  {
    ...
    uniffi_vt_ffi_fn_method_zutalkcore_list_context_pack_sources(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(notebookId),
...
open func listLibraryContextPacks()throws  -> [FfiContextPackInfo]  {
    ...
    uniffi_vt_ffi_fn_method_zutalkcore_list_library_context_packs(
            self.uniffiCloneHandle(),$0
    )
})
}
...
open func listNotebookCaptureHistory(notebookId: String)throws  -> [FfiNotebookCaptureHistoryRun]  {
    ...
    uniffi_vt_ffi_fn_method_zutalkcore_list_notebook_capture_history(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(notebookId),$0
    )
})
...
open func listNotebookCaptureHistorySummaries(notebookId: String)throws  -> [FfiNotebookCaptureHistoryRun]  {
    return try  FfiConverterSequenceTypeFfiNotebookCaptureHistoryRun.lift(try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_list_notebook_capture_history_summaries(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(notebookId),$0
    )
})
...
open func listNotebookCaptureHistoryUtterances(notebookId: String, sessionId: String)throws  -> [FfiNotebookCaptureUtterance]  {
    ...
    uniffi_vt_ffi_fn_method_zutalkcore_list_notebook_capture_history_utterances(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(notebookId),
        FfiConverterString.lower(sessionId),$0
    )
...
open func listNotebookCaptureUtterances(sessionId: String)throws  -> [FfiNotebookCaptureUtterance]  {
    return try  FfiConverterSequenceTypeFfiNotebookCaptureUtterance.lift(try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_list_notebook_capture_utterances(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(sessionId),$0
    )
})
...
open func pauseNotebookCaptureSession(sessionId: String, paused: Bool)throws  -> FfiNotebookCaptureEvent  {
    return try  FfiConverterTypeFfiNotebookCaptureEvent_lift(try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_pause_notebook_capture_session(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(sessionId),
...
open func previewNotebookCaptureContext(notebookId: String)throws  -> FfiNotebookCaptureContextPreview  {
    ...
    uniffi_vt_ffi_fn_method_zutalkcore_preview_notebook_capture_context(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(notebookId),$0
    )
})
...
open func projectNotebookRealtimeIncremental(sessionId: String)throws   {try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_project_notebook_realtime_incremental(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(sessionId),$0
    )
}
...
open func pushNotebookCaptureSession(sessionId: String, audioData: Data)throws   {try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_push_notebook_capture_session(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(sessionId),
...
open func readLibraryContextPack(packId: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_read_library_context_pack(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(packId),$0
    )
})
...
open func replaceLibraryContextPack(packId: String, expectedRevision: UInt64, documentJson: String)throws  -> FfiContextPackInfo  {
    return try  FfiConverterTypeFfiContextPackInfo_lift(try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_replace_library_context_pack(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(packId),
...
open func replaceNotebookUtteranceLane(utteranceId: String, laneLanguage: String, text: String, expectedRevision: UInt64)throws  -> FfiNotebookCaptureUtterance  {
    ...
    uniffi_vt_ffi_fn_method_zutalkcore_replace_notebook_utterance_lane(
            self.uniffiCloneHandle(),
...
open func retryNotebookAsyncProjection(sessionId: String)throws  -> FfiNotebookCaptureEvent  {
    return try  FfiConverterTypeFfiNotebookCaptureEvent_lift(try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_retry_notebook_async_projection(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(sessionId),$0
    )
})
...
open func retryNotebookCaptureProjection(sessionId: String)throws  -> FfiNotebookCaptureEvent  {
    return try  FfiConverterTypeFfiNotebookCaptureEvent_lift(try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_retry_notebook_capture_projection(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(sessionId),$0
    )
})
...
open func setLaneCredentialRequester(requester: FfiLaneCredentialRequester?)  {try! rustCall() {
    uniffi_vt_ffi_fn_method_zutalkcore_set_lane_credential_requester(
            self.uniffiCloneHandle(),
...
open func setNotebookContextPackBinding(notebookId: String, packId: String, position: UInt64?)throws   {try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_set_notebook_context_pack_binding(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(notebookId),
        FfiConverterString.lower(packId),
...
open func startNotebookCaptureSession(notebookId: String, profileRevision: UInt64, confirmedContextDigest: String?, callback: FfiNotebookCaptureCallback)throws  -> FfiNotebookCaptureEvent  {
    return try  FfiConverterTypeFfiNotebookCaptureEvent_lift(try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_start_notebook_capture_session(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(notebookId),
...
open func stopNotebookCaptureSession(sessionId: String)throws  -> FfiNotebookCaptureEvent  {
    return try  FfiConverterTypeFfiNotebookCaptureEvent_lift(try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_stop_notebook_capture_session(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(sessionId),$0
    )
})
...
open func updateNotebookCaptureProfile(profile: FfiNotebookCaptureProfile)throws  -> FfiNotebookCaptureProfile  {
    return try  FfiConverterTypeFfiNotebookCaptureProfile_lift(try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_update_notebook_capture_profile(
            self.uniffiCloneHandle(),
...
open func getAudioDestructionReport(sessionId: String)throws  -> AudioDestructionReportInfo  {
    ...
    uniffi_vt_ffi_fn_method_zutalkcore_get_audio_destruction_report(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(sessionId),$0
    )
})
...
open func getAudioSegment(sessionId: String, startMs: UInt64, endMs: UInt64)throws  -> Data  {
    ...
    uniffi_vt_ffi_fn_method_zutalkcore_get_audio_segment(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(sessionId),
...
open func getTaskStatus(taskId: String)throws  -> TaskInfoDto  {
    ...
    uniffi_vt_ffi_fn_method_zutalkcore_get_task_status(
            self.uniffiCloneHandle(),
...
open func getSessionTranscriptClipboardText(sessionId: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_get_session_transcript_clipboard_text(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(sessionId),$0
    )
})
...
open func listNotebookSessionSpeakers(sessionId: String)throws  -> [FfiSessionSpeaker]  {
    ...
    uniffi_vt_ffi_fn_method_zutalkcore_list_notebook_session_speakers(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(sessionId),$0
    )
})
...
open func listSpeakerParticipants()throws  -> [FfiSpeakerParticipant]  {
    ...
    uniffi_vt_ffi_fn_method_zutalkcore_list_speaker_participants(
            self.uniffiCloneHandle(),$0
    )
})
}
...
open func renameNotebookSessionSpeaker(sessionSpeakerId: String, localDisplayName: String?)throws  -> FfiSessionSpeaker  {
    return try  FfiConverterTypeFfiSessionSpeaker_lift(try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_rename_notebook_session_speaker(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(sessionSpeakerId),
...
open func renameSpeakerParticipant(participantId: String, displayName: String)throws  -> FfiSpeakerParticipant  {
    return try  FfiConverterTypeFfiSpeakerParticipant_lift(try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_rename_speaker_participant(
            self.uniffiCloneHandle(),
...
open func unlinkNotebookSessionSpeaker(sessionSpeakerId: String)throws  -> FfiSessionSpeaker  {
    return try  FfiConverterTypeFfiSessionSpeaker_lift(try rustCallWithError(FfiConverterTypeCoreError_lift) {
    uniffi_vt_ffi_fn_method_zutalkcore_unlink_notebook_session_speaker(
            self.uniffiCloneHandle(),
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeZuTalkCore: FfiConverter {
    typealias FfiType = UInt64
    typealias SwiftType = ZuTalkCore

    public static func lift(_ handle: UInt64) throws -> ZuTalkCore {
        return ZuTalkCore(unsafeFromHandle: handle)
    }

    public static func lower(_ value: ZuTalkCore) -> UInt64 {
        return value.uniffiCloneHandle()
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> ZuTalkCore {
        let handle: UInt64 = try readInt(&buf)
        return try lift(handle)
    }

    public static func write(_ value: ZuTalkCore, into buf: inout [UInt8]) {
        writeInt(&buf, lower(value))
    }
}
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeZuTalkCore_lift(_ handle: UInt64) throws -> ZuTalkCore {
    return try FfiConverterTypeZuTalkCore.lift(handle)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeZuTalkCore_lower(_ value: ZuTalkCore) -> UInt64 {
    return FfiConverterTypeZuTalkCore.lower(value)
}
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_vt_ffi_checksum_method_zutalkcore_api_version() != 35330) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_available_locales() != 26391) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_clear_api_key() != 24211) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_complete_provider_credential_bootstrap() != 56364) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_current_locale() != 53960) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_vt_ffi_checksum_method_zutalkcore_get_session() != 36873) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_vt_ffi_checksum_method_zutalkcore_purge_session() != 62763) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_query_sessions() != 8485) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_restore_session() != 47738) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_vt_ffi_checksum_method_zutalkcore_set_privacy_default() != 25109) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_shutdown() != 50836) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_soft_delete_session() != 29513) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_vt_ffi_checksum_method_zutalkcore_block_document_open() != 47999) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_note_apply_outline() != 53504) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_note_block_document_open() != 59142) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_note_outline_rows() != 31871) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_note_redo() != 29946) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_note_undo() != 65086) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_vt_ffi_checksum_method_zutalkcore_transcript_insert_annotation() != 25994) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_transcript_machine_upsert() != 5748) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_transcript_user_replace_lane() != 47542) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_transcript_user_replace_text() != 59963) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_apply_edit() != 55668) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_close_editor() != 14146) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_flush_all_editors_sync() != 38262) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_get_editor_content() != 21131) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_get_editor_delta() != 20802) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_is_editor_writable() != 25206) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_open_editor() != 26856) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_register_editor_callback() != 51774) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_vt_ffi_checksum_method_zutalkcore_list_notebook_session_projections() != 7090) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_list_notebook_sessions() != 57154) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_list_notebook_tabs() != 1444) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_list_notebooks() != 45441) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_move_session_to_notebook() != 24036) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_vt_ffi_checksum_method_zutalkcore_create_library_context_pack() != 45576) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_delete_context_pack_source() != 9931) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_delete_library_context_pack() != 51138) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_export_context_pack() != 20833) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_fail_lane_credential() != 2352) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_fulfill_lane_credential() != 1624) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_get_notebook_capture_engine_descriptor() != 56339) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_get_notebook_capture_profile() != 18687) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_get_notebook_capture_session_event() != 28551) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_import_context_pack() != 20167) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_import_context_pack_text() != 61575) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_interrupt_notebook_capture_session() != 12424) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_list_context_pack_sources() != 721) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_list_library_context_packs() != 53092) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_list_notebook_capture_history() != 63633) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_list_notebook_capture_history_summaries() != 30475) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_list_notebook_capture_history_utterances() != 7335) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_list_notebook_capture_utterances() != 63533) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_vt_ffi_checksum_method_zutalkcore_preview_notebook_capture_context() != 3912) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_project_notebook_realtime_incremental() != 53793) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_push_notebook_capture_session() != 46228) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_read_library_context_pack() != 60270) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_replace_library_context_pack() != 38834) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_replace_notebook_utterance_lane() != 24055) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_vt_ffi_checksum_method_zutalkcore_retry_notebook_capture_projection() != 30228) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_set_lane_credential_requester() != 18250) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_set_notebook_context_pack_binding() != 18712) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_start_notebook_capture_session() != 47896) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_stop_notebook_capture_session() != 6332) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_update_notebook_capture_profile() != 26473) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_get_audio_destruction_report() != 4726) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_get_audio_segment() != 33850) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_get_task_status() != 3871) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_vt_ffi_checksum_method_zutalkcore_list_notebook_session_speakers() != 28870) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_list_speaker_participants() != 33666) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_vt_ffi_checksum_method_zutalkcore_rename_notebook_session_speaker() != 5952) {
        return InitializationResult.apiChecksumMismatch
    }
