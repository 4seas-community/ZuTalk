...
//   2. Unit test (ZuTalkTests) — 菜单栏 status item ✗ (NSStatusBar 在 XCTest 进程不稳) onboarding ✓ STT 真
//   3. UI test (ZuTalkUITests) — 菜单栏 status item ✓ (供黑盒测试触发) onboarding ✗ STT mock
//
// 检测策略:
