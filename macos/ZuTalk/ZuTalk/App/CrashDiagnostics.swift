...
private func ZuTalkUncaughtExceptionHandler(_ exception: NSException) {
...
enum CrashDiagnostics {
    ...
    static func install() {
        ...
        NSSetUncaughtExceptionHandler(ZuTalkUncaughtExceptionHandler)
